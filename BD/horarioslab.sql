...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`uea` (`iduea`, `nombreuea`, `horarioi`, `horariof`, `laboratorios_idlaboratorios`, `divisiones_iddivisiones`) VALUES (1, 'programación avanzada', '10:00', '13:00', 105, 1);
INSERT INTO `mydb`.`uea` (`iduea`, `nombreuea`, `horarioi`, `horariof`, `laboratorios_idlaboratorios`, `divisiones_iddivisiones`) VALUES (2, 'introducción a la programación', '16:00', '19:00', 220, 1);
INSERT INTO `mydb`.`uea` (`iduea`, `nombreuea`, `horarioi`, `horariof`, `laboratorios_idlaboratorios`, `divisiones_iddivisiones`) VALUES (3, 'sistemas operativos', '08:00', '11:00', 106, 1);
INSERT INTO `mydb`.`uea` (`iduea`, `nombreuea`, `horarioi`, `horariof`, `laboratorios_idlaboratorios`, `divisiones_iddivisiones`) VALUES (4, 'programación aplicada a la química', '11:00', '13:00', 106, 2);
INSERT INTO `mydb`.`uea` (`iduea`, `nombreuea`, `horarioi`, `horariof`, `laboratorios_idlaboratorios`, `divisiones_iddivisiones`) VALUES (5, 'programación a la química organica', '11:00', '13:00', 106, 2);
INSERT INTO `mydb`.`uea` (`iduea`, `nombreuea`, `horarioi`, `horariof`, `laboratorios_idlaboratorios`, `divisiones_iddivisiones`) VALUES (6, 'programación en la administración', '08:00', '11:00', 106, 3);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`usuarioadmin` (`idusuarioadmin`, `usuario`, `pass`) VALUES (1, 'admin', 'admin');
